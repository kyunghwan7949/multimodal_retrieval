...
def compute_mse(scores, labels):
    mse_loss = nn.MSELoss()
    return mse_loss(scores, labels)


# def compute_itm(image_features, text_features, logit_scale):
...
#     sim_t2i = logit_scale * t2i_cosine_theta
#     sim_i2t = logit_scale * i2t_cosine_theta
...
#     neg_idx = torch.multinomial(weights_t2i, 1).item()
#     image_embeds_neg.append(image_norm[neg_idx])
