...
class RetrievalGraphDataset(Dataset):
    ...
    def __init__(self, args, split, mlm=False, max_length=77, cache=False):
        ...
        self.graph_path = f'/data/data2/khahn/MGM_train/data/RSTPReid/dp_graph/fin_train'
        ...
        self.annotation  = json.load(open("/data/data2/khahn/MGM_train/data/RSTPReid/annotations/merged_train.json", "r"))
...
class RetrievalGraphEvalDataset(Dataset):
    ...
    def __init__(self, args, split, max_length=77):
        ...
        ## RSTPReid
        self.img_path = op.join('/data/data2/khahn/MGM_train/data/RSTPReid/imgs')
        self.graph_path = f'/data/data2/khahn/MGM_train/data/RSTPReid/dp_graph/fin_val'
        # self.cache_path = f'/data/data2/khahn/MGM_train/data/dp_graph/cache'
        ...
        self.annotation  = json.load(open("/data/data2/khahn/MGM_train/data/RSTPReid/annotations/merged_val.json", "r"))
