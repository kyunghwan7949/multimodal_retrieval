...
class GraphFeatureTokenizer(nn.Module):
    ...
    def __init__(
        ...
        self.id_encoder = nn.Embedding(num_ids,hidden_dim, padding_idx=0)
    ...
    @staticmethod
    def get_batch(node_feature, edge_index, node_num, perturb=None, max_length=77):
        """
    ...
    def forward(self, batched_data, perturb=None, mlm=False):
        ...
        node_feature = self.id_encoder(node_data)
        ...
        padded_index, padded_feature, padding_mask, _ = self.get_batch(
            node_feature, edge_index, node_num, perturb
        )
