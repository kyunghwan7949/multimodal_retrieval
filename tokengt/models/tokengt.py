...
class TokenGTEncoder(FairseqEncoder):
    ...
    def forward(self, batched_data, perturb=None, mlm=False, masked_tokens=None, **unused):
        inner_states, graph_rep, attn_dict = self.graph_encoder(batched_data, perturb=perturb, mlm=mlm)
